...
public class MinesweeperGame {
    ...
    private static void initializeGame() {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 10; j++) {
                int count = 0;
                if (!isLandMinCell(i, j)) {
                    if (i - 1 >= 0 && j - 1 >= 0 && isLandMinCell(i - 1, j - 1)) {
                        count++;
                    }
                    if (i - 1 >= 0 && isLandMinCell(i - 1, j)) {
                        count++;
                    }
                    if (i - 1 >= 0 && j + 1 < 10 && isLandMinCell(i - 1, j + 1)) {
                        count++;
                    }
                    if (j - 1 >= 0 && isLandMinCell(i, j - 1)) {
                        count++;
                    }
                    if (j + 1 < 10 && isLandMinCell(i, j + 1)) {
                        count++;
                    }
                    if (i + 1 < 8 && j - 1 >= 0 && isLandMinCell(i + 1, j - 1)) {
                        count++;
                    }
                    if (i + 1 < 8 && isLandMinCell(i + 1, j)) {
                        count++;
                    }
                    if (i + 1 < 8 && j + 1 < 10 && isLandMinCell(i + 1, j + 1)) {
                        count++;
                    }
